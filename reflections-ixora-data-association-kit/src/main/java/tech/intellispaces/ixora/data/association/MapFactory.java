...
public class MapFactory implements MapAssistantCustomizer {
  ...
  public  <K, V> Map<K, V> reflectionOf(java.util.Map<K, V> map, Class<K> keyClass, Class<V> valueClass) {
    return new JavaMapReflectionWrapper<>(map, keyClass, valueClass);
  }

  public <K, V> Map<K, V> reflectionOf(java.util.Map<K, V> map, Type<K> keyType, Type<V> valueType) {
